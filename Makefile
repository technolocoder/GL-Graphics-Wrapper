...
$(build_path)Camera.o : $(src_path)Camera.cpp $(include_path)Camera.hpp
	g++ $(src_path)Camera.cpp -c -o$(build_path)Camera.o -O3 -I$(include_path) -I$(include_path)Dependencies

$(build_path)Mesh.o : $(src_path)Mesh.cpp $(include_path)Mesh.hpp
	g++ $(src_path)Mesh.cpp -c -o$(build_path)Mesh.o -O3 -I$(include_path) -I$(include_path)Dependencies

$(build_path)Model.o : $(src_path)Model.cpp $(include_path)Model.hpp
	g++ $(src_path)Model.cpp -c -o$(build_path)Model.o -O3 -I$(include_path) -I$(include_path)Dependencies

$(build_path)Program.o : $(src_path)Program.cpp $(include_path)Program.hpp
	g++ $(src_path)Program.cpp -c -o$(build_path)Program.o -O3 -I$(include_path) -I$(include_path)Dependencies

$(build_path)Shader.o : $(src_path)Shader.cpp $(include_path)Shader.hpp
	g++ $(src_path)Shader.cpp -c -o$(build_path)Shader.o -O3 -I$(include_path) -I$(include_path)Dependencies

$(build_path)Texture.o : $(src_path)Texture.cpp $(include_path)Texture.hpp
	g++ $(src_path)Texture.cpp -c -o$(build_path)Texture.o -O3 -I$(include_path) -I$(include_path)Dependencies
